...
const ShowLead = () => {
  ...
  const handleClick = async (id, checkStatus) => {
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URI}/leads/${id}/${
          checkStatus ? "approve/" : "reject/"
        }`,
        {
          method: "PATCH",
          headers: {
